...
//工具栏
    ...
    ui->mainToolBar->addAction(actAbout); // 将按钮添加到工具栏
...
{ //信号与槽的关联，当函数带有参数时，必须写明参数的类型
    ...
    // 连接About按钮的信号与槽
    connect(ui->mainToolBar->actions().last(), &QAction::triggered, this,
            &QWMainWind::on_actAbout_triggered);
}
...
{
    QString info = "姓名：郭敏\n学号：2022414120208\n";
    QMessageBox::about(this, "关于", info); // 显示About窗口
}
